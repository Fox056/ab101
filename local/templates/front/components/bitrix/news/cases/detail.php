...
$elementID = $objFindTools->GetElementID(false, $arResult['VARIABLES']['ELEMENT_CODE'], false,  false, CASES);
$ipropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues(CASES,$elementID);
