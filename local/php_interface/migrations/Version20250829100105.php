...
class Version20250829100105 extends Version
{
    protected $author = "admin";

    protected $description = "Кейсы";
  ...
  array (
    'ru' => 
    array (
      'NAME' => 'Инфоблоки на главной ',
      'SECTION_NAME' => '',
      'ELEMENT_NAME' => '',
    ),
    'en' => 
    array (
      'NAME' => 'Infoblocks in main_page',
      'SECTION_NAME' => '',
      'ELEMENT_NAME' => '',
    ),
  ),
  ...
  'SORT' => '2',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/cases/#ELEMENT_CODE#/',
  'SECTION_PAGE_URL' => '',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  array (
    ...
    'IS_REQUIRED' => 'N',
    'DEFAULT_VALUE' => 'Первичная оптимизация, проектирование структуры, разработка SEO-фильтра.',
    'VISIBLE' => 'Y',
  ),
  'DETAIL_PICTURE' => 
  array (
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Активная картинка на обложке',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'ACTIVE_IMG',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    'PROPERTY_PERIOD' => 'Период',
    'NAME' => 'Название',
    'CODE' => 'Символьный код',
    'SORT' => 'Сортировка',
    'IBLOCK_ELEMENT_PROP_VALUE' => 'Значения свойств',
    'PROPERTY_TRAFFIC' => 'Увеличил трафик',
    'PROPERTY_CONVERSION' => 'Увеличил конверсию',
  ),
  'Анонс|edit5' => 
  array (
  ...
  'Анонс новый дизайн|cedit1' => 
  array (
    'PROPERTY_TARGET' => 'Цель',
    'PROPERTY_COLUMNS_GRAPH' => 'Колонки графика',
  ),
  'Подробно|edit6' => 
  array (
    'DETAIL_PICTURE' => 'Детальная картинка',
    'PROPERTY_ACTIVE_IMG' => 'Активная картинка на обложке',
